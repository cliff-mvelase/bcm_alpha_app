...
class WithdrawalViewCancelledReqstScreen extends StatefulWidget {
  static const routeName = '/withdrawalViewCancelled';

  @override
  _WithdrawalViewCancelledReqstScreenState createState() =>
      _WithdrawalViewCancelledReqstScreenState();
}

class _WithdrawalViewCancelledReqstScreenState
    extends State<WithdrawalViewCancelledReqstScreen> {
      ...
      setState(() {
        ...
        if (withdrawals.isNotEmpty) {
          withdrawals = withdrawals
              .where((withdrawal) => withdrawal['status'] == 'cancelled')
              .toList();
          isLoading = false;
        }
      });
