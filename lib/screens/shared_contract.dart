...
class SharedContract extends StatefulWidget {
  ...
  SharedContract({Key ? key}) : super(key: key);
  @override
  _SharedContractState createState() => _SharedContractState();
}

class _SharedContractState extends State<SharedContract> {
